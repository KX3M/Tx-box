...
async def download_video(url, reply_msg, user_mention, user_id):
    ...
    if data.get("ok") == True:
        video_title = data.get("filename")
        download_link = data.get("downloadlink")
        thumbnail_url = data.get("thumbnail", "")  # Assuming the response contains a "thumbnail" field
        ...
        raise Exception("Invalid API response or missing 'ok' field")
