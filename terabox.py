...
ADMINS = list(map(int, os.environ.get('ADMINS', '6076683960').split()))
if not ADMINS:
...
mongo_url = os.environ.get('MONGO_URL', 'mongodb+srv://Outlawbots:Zoro@cluster0.huekk.mongodb.net/?retryWrites=true&w=majority')
